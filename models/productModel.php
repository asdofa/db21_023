<?php
    class Product
    {
        ...
        public $PROD_Minimum;
        public $PROD_Detail;
        public function __construct($PROD_ID,$PROD_Name,$PROD_Category,$PROD_Type,$PROD_Minimum,$PROD_Detail)
        {
        ...
        public static function getAll()
        {
            ...
            while($my_row = $result->fetch_assoc())
            {
                ...
                $productList[]=new Product($PROD_ID,$PROD_Name,$PROD_Category,$PROD_Type,$PROD_Minimum,$PROD_Detail);
            }
