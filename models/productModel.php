<?php
    class Rate
    {
        ...
        public $PROD_Minimum;
        public $PROD_Detail;
        public function __construct($PROD_ID,$PROD_PROD_NameQTY,$PROD_Category,$PROD_Type,$PROD_Minimum,$PROD_Detail)
        {
        ...
        public static function getAll()
        {
            ...
            while($my_row = $result->fetch_assoc())
            {
                ...
                $rateList[]=new RATE($PROD_ID,$PROD_PROD_NameQTY,$PROD_Category,$PROD_Type,$PROD_Minimum,$PROD_Detail);
            }
